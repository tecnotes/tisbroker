TISBROKER (Программа "быстрое переключение пользователей") - позволяет производить быстрое завершение сеанса авторизации пользователя и переключаться между различными компьютерами и IP адресами.
